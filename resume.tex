...
\CompanyHeader{National Robotics Engineering Center (NREC)}{Pittsburgh, PA}{Robotics Engineer}{April 2013}
\ResumeItem{Developed a Qt interface that utilized OpenGl to debug robotic path planning applications}
\ResumeItem{Created a distributed system to run simulations on over 60 machines, running over 10000 simulations}
