...
\newcommand{\address}{\footnotesize 250 Hidden Ridge Court APT 202\hspace{2px}\textbullet\hspace{2px}South Park, PA 15129\hspace{2px}\textbullet\hspace{2px}(330)340-4751}
...
\ResumeItem{Developed real time software for saftey critical embedded systems}
\ResumeItem{Developed simulation and unit testing tools to support debugging of embedded software}
\CompanyHeader{Carnegie Robotics}{Pittsburgh, PA}{Consultant}{July 2011 \textendash { August 2011}}
\ResumeItem{Implemented and tuned a PID controler to control the robot base over a UDP interface}
\ResumeItem{Created a serial driver to interface with a Pan, Tilt, and Zoom Camera}
...
\CompanyHeader{Intelligent Ground Vehicle Competition (IGVC)}{}{Sensor Fusion/Localization Lead (2009,2010)}{Spring 2009 \textendash { }Summer 2010}
 ...
 \ResumeItem{Compared the A*, D* and D* lite path planning algorithms}
